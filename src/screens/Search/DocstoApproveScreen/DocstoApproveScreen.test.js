...
import { DocstoApproveScreen } from "./DocstoApproveScreen";
  ...
  it("should render the component correctly", () => {
    ...
    const mockStore = createStore(mockReducer, {
      ...
      post: {
        ...
        ActualPostFirebase: "test-photo",
      },
      home: {
        servicesData: "test-photo",
        approvalList: ["test-photo"],
        totalEventServiceAITLIST: ["test-photo"],
      },
      search: {
        approvalListNew: ["test-photo"],
      },
    });
