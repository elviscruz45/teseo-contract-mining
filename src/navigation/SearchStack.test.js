...
jest.mock("../screens/Search/MoreDetailScreen/MoreDetailScreen", () => ({
  MoreDetailScreen: jest.fn(() => null),
}));

jest.mock("../screens/Search/FilesScreen/FileScreen", () => ({
  FileScreen: jest.fn(() => null),
}));

jest.mock("../screens/Search/DocstoApproveScreen/DocstoApproveScreen", () => ({
  DocstoApproveScreen: jest.fn(() => null),
}));

jest.mock("../screens/Search/EditAITScreen/EditAITScreen", () => ({
  EditAITScreen: jest.fn(() => null),
}));
jest.mock("../screens", () => ({
  SearchScreen: jest.fn(() => null),
}));
...
jest.mock("../screens/Search/ItemScreen", () => ({
  ItemScreen: jest.fn(() => null),
}));
    ...
    const { getByTestId } = render(
      <NavigationContainer>
        <Provider store={mockStore}>
          <Tab.Navigator>
            <Tab.Screen name="Publicar" component={SearchStack} />
          </Tab.Navigator>
        </Provider>
      </NavigationContainer>
    );
